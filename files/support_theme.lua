...
EXPORTS = {
    ...
    SwitchColorTheme = function()
        ...
        colors[clr.ScrollbarGrabHovered] = ImVec4(0.76, 0.31, 0.00, 0.5)
        colors[clr.ScrollbarGrabActive] = ImVec4(0.76, 0.31, 0.00, 1.00)
        colors[clr.ComboBg] = ImVec4(0.19, 0.18, 0.21, 1.00)
        colors[clr.CheckMark] = ImVec4(1.00, 0.42, 0.00, 0.53)
        colors[clr.SliderGrab] = ImVec4(0.76, 0.31, 0.00, 1.00)
        colors[clr.SliderGrabActive] = ImVec4(0.76, 0.31, 0.00, 1.00)
